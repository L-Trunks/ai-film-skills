...
(you won't hear it in the GIF; grab the mp4 above). Each segment contains its own hard cut.
The sense of intimacy comes entirely from **distance plus a physical action aimed at the lens**:
the move above — "steps closer and closer until her face fills the frame" — works;
"rests her head on the camera's shoulder" does not.
